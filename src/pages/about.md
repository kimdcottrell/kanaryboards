...
<span class="font-cherry-bomb-one text-3xl">_the dream of never again having to work with horrible task management software._</span>

## From the Founder

I'm [Kim Cottrell](https://kimdcottrell.com), a software developer who has made things on the web for over a decade. 

Over the course of my career (and rather, life), I've dreamed of a productivity tool that would:

- Actually help me become **more** productive (and not by increasing my workload!)

- Make overwhelming goals feel manageable instead of anxiety-inducing

- Let me work in a way that feels natural and individualized, rather than forcing me to follow the latest productivity trend or micromanager-approved workflow
...
The technology isn't there yet. You know it. I know it. But too many cannot resist the siren song of Jensen Huang in his leather jacket claiming otherwise as Nvidia remains the _only_ profitable player in the AI space. 

> If that $500,000 engineer did not consume at least $250,000 worth of tokens, I am going to be deeply alarmed
- Jensen Huang

<small class="text-[0.625rem]">People seriously view this as good advice. Somehow.</small>
...
I wanted to build something that can _help_ the human builders out there, _not_ replace them.
...
- I may have bills to pay, but so does everyone else. The free tier should feel like a "Costco hot dog meal" level of value.

- Wherever AI is added, it should genuinely help users accomplish their goals

- Kanby shouldn't require a certification to be able to be understood by the end user
...
- <a href="/dashboard" data-open-clerk-sign-up-modal>signing up</a>
(it's free and we do **not** sell your data!)
- <a href="https://buymeacoffee.com/kanby" target="_blank">donating</a> to help fund the project's development
- following Kanby on <a href="#social-media-links">social media </a>
- signing up for <a href="#mc_embed_shell">the newsletter</a>
