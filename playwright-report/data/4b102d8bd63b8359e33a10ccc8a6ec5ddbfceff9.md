...
- Name: collapse.spec.ts >> Collapse functionality >> Row section >> re-expands when toggled again
- Location: tests/collapse.spec.ts:75:9
...
> 6   |     await page.goto("http://app:4321");
      |                ^ Error: page.goto: net::ERR_SSL_PROTOCOL_ERROR at http://app:4321/
  7   |   });
  8   | 
  9   |   /**
