import { AlertId, BuiltInColors, CardActionId, Clerk, ClerkOptions, ClientResource, EnterpriseProvider, FieldId, InternalClerkScriptProps, MenuId, MultiDomainAndOrProxyPrimitives, OAuthConsentProps, OAuthProvider, OrganizationListProps, OrganizationPreviewId, OrganizationProfileProps, OrganizationSwitcherProps, PhoneCodeChannel, PricingTableProps, ProfilePageId, ProfileSectionId, ProtectParams, SamlIdpSlug, SelectId, SignInProps, SignUpProps, TransparentColor, UserButtonProps, UserPreviewId, UserProfileProps, WaitlistProps, Web3Provider, Without } from "@clerk/shared/types";
...
//#endregion
export { InternalUIComponentId as a, ButtonProps as i, AstroClerkIntegrationParams as n, ProtectProps as o, AstroClerkUpdateOptions as r, Ui as s, AstroClerkCreateInstanceParams as t };
//# sourceMappingURL=types-D1e50xiL.d.ts.map